...
function createPokemonCard(info) {
    ...
    $$info1.innerHTML = "<span><b>Attack</b></span><span class='gallery__attack'>" + info.attack + "</span>";

    const $$info2 = document.createElement('div');
    $$info2.className = "gallery__info";
    $$info2.innerHTML = "<span><b>Defense</b></span><span class='gallery__defense'>" + info.defense + "</span>";

    const $$info3 = document.createElement('div');
    $$info3.className = "gallery__info";
    $$info3.innerHTML = "<span><b>Speed</b></span><span class='gallery__speed'>" + info.speed + "</span>";
